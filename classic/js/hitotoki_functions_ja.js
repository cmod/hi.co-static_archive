...
function swapFeatured(x) {
	...
	var newHTML = '<div class="featured_poster"><span class="issue_no"><a href="'+ hitotokiData[x].url +'">'+ hitotokiData[x].issue +'</a></span><a href="'+ hitotokiData[x].url +'"><img src="' + hitotokiData[x].img + '" alt="' + hitotokiData[x].location + '" /></a></div>';
	newHTML += '<h2>&ldquo;<a href="'+ hitotokiData[x].url +'">' + hitotokiData[x].title + '</a>&rdquo;</h2>';
	newHTML += '<p>' + hitotokiData[x].author + ' (' + hitotokiData[x].homeland + '出身)<br />'+ hitotokiData[x].location +'</p></div>';
