	...
	if (document.getElementsByTagName)
		for(i=0; (a = document.getElementsByTagName("script")[i]); i++)
			if(a.getAttribute("src"))
			{
				...
				d = b.indexOf("https://maps.google.com/maps?file=api");
				e = b.indexOf("key=");
				if (c > 0)
...
function poweredByClick(map) {
	...
	var url = "https://maps.google.com/maps?ll=" + center.lat() + "," + center.lng() + "&spn=" + shorten(span.lat()) + "," + shorten(span.lng()) + "&z=" + zoom + "&key=" + APIkey;
...
function getPoweredBy(map) {
	try {
		...
		b.setAttribute("src","https://www.google.com/intl/en_ALL/mapfiles/transparent.gif");
...
PdMarker.prototype.showDetailWin = function() {
	...
	var html = "<table><tr><td>" + this.detailWinHTML + "<\/td><td valign='top'><a class='markerDetailClose' href='javascript:PdMarkerClose(" + this.internalId + ")'><img src='https://www.google.com/mapfiles/close.gif' width='14' height='13'><\/a><\/td><\/tr><\/table>";
